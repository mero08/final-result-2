...
const projects = [
  { id: 1, title: 'Ranked Night Raid', category: 'YouTube video', year: '2025', color: 'from-amber-900/40', youtubeId: 'f61OclqoDGU' },
  { id: 2, title: 'Warzone Montage', category: 'YouTube video', year: '2026', color: 'from-blue-900/40', youtubeId: 'YSz86a7bhxk' },
];
      ...
      {activeProject && activeProjectData && (
        <div className="cinema-overlay" onClick={() => setActiveProject(null)}>
          <button
            ...
            className="absolute top-6 right-6 p-2.5 rounded-full bg-black/40 border border-white/20 text-white hover:text-white hover:border-white/60 hover:bg-black/60 transition-all duration-200 cursor-pointer z-[60]"
            aria-label="Close"
          >
            <X className="w-6 h-6" />
          </button>
